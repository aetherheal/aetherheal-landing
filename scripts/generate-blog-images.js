#!/usr/bin/env node
// Batch-generate blog cover images via Google Imagen 4.
//
// Usage:
//   node scripts/generate-blog-images.js              # generate all missing
//   node scripts/generate-blog-images.js --dry-run    # print prompts only, no API call
//   node scripts/generate-blog-images.js --only=filler# filter by slug substring
//   node scripts/generate-blog-images.js --force      # regenerate even if file exists
//
...
const OUTPUT_DIR = path.join(ROOT, "public", "assets", "blog");
