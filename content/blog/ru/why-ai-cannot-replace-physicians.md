---
title: "Почему ИИ не может заменить врачей — и что он должен делать вместо этого"
description: "Все задают неправильный вопрос об ИИ в медицине. Вопрос не в том, может ли ИИ заменить врачей. А в том, что именно делают врачи, что нельзя делегировать — и почему понимание этого различия меняет подход к созданию ИИ-систем для здравоохранения."
date: "2026-03-22"
