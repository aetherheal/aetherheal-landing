...
tags: ["korea-medical-system", "plastic-surgery", "dermatology", "dental", "medical-specialty", "board-certification", "patient-guide"]
coverImage: "/assets/blog/korea-specialty-guide-dermatology-plastic-surgery-cover.webp"
published: true
takeaways:
  - "In Korea's medical system, choosing the correct specialty for your procedure is more important than choosing a famous hospital — each specialty has distinct training, licensing, and legal scope."
  - "Board certification (전문의, jeonmunui) in Korea requires four years of residency training after medical school and a national examination; it is the single most reliable credential to verify before any procedure."
  - "Dermatologists (피부과), plastic surgeons (성형외과), and oral-maxillofacial surgeons (구강외과) each have legally defined scopes under Korea's Medical Act (의료법), though some procedures fall in overlapping zones."
  - "Some Korean clinics deliberately blur specialty boundaries for commercial reasons — a plastic surgery clinic offering laser treatments or a dermatology clinic performing surgical rhinoplasty may be operating outside its core training."
  - "The goal of understanding specialty boundaries is not rigid categorization but informed choice — knowing which questions to ask and which credentials to verify before committing to a procedure."
faq:
  - q: "What is the difference between a dermatologist and a plastic surgeon in Korea?"
...
![A signpost at an intersection with directional arrows pointing toward different medical specialties, symbolizing the decision patients face before choosing a provider](/assets/blog/korea-specialty-guide-dermatology-plastic-surgery-body-signpost.webp)
...
At [AetherHeal](/en/explore), physician-led navigation begins with matching you to the right specialty and the right specialist — not the most marketed clinic. [Dr. Jee Hoon Ju](/en/doctors/dr-jee-hoon-ju) reviews cases through a clinical lens that prioritizes specialty-appropriate care.
