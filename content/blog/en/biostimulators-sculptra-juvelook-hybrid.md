...
tags: ["biostimulators", "sculptra", "juvelook", "plla", "pdlla", "collagen-stimulator", "regenerative-medicine", "korea"]
coverImage: "/assets/blog/biostimulators-sculptra-juvelook-hybrid-cover.webp"
published: true
takeaways:
  - "Biostimulators like Sculptra, Juvelook, AestheFill, Radiesse, and Ellanse all work through a shared mechanism — controlled foreign body reaction leading to collagen neogenesis — but differ in material, degradation timeline, and clinical behavior."
  - "Korea's Juvelook (PDLLA) uses uniform microspheres that degrade more predictably than PLLA's crystalline particles, offering a smoother collagen stimulation curve with fewer risks of nodule formation."
  - "Hybrid protocols — combining energy devices like fractional lasers or radiofrequency with biostimulators — represent a genuine evolution in treatment design, using controlled micro-injury to amplify the collagen-building response."
  - "Patient selection matters more for biostimulators than for HA fillers: ideal candidates have early-to-moderate volume loss and intact healing capacity, while patients with autoimmune conditions or unrealistic timeline expectations may not be appropriate."
  - "Long-term comparative data between PDLLA and PLLA, and safety data on newer PDLLA+HA hybrids, are still accumulating — the theoretical advantages of PDLLA are well-grounded but not yet confirmed by decade-scale evidence."
faq:
  - q: "What is the difference between a dermal filler and a biostimulator?"
    a: "A dermal filler like hyaluronic acid adds immediate volume by physically occupying space under the skin. A biostimulator like Sculptra or Juvelook triggers your body to produce new collagen over weeks to months. The volume from a biostimulator is your own tissue, not an injected gel. This means results appear gradually, last longer, and feel more natural — but they cannot be dissolved with hyaluronidase if you are unhappy with the result."
  - q: "Is Juvelook the same as Sculptra?"
    a: "No. Sculptra uses poly-L-lactic acid (PLLA), while Juvelook uses poly-D,L-lactic acid (PDLLA). PLLA is semi-crystalline and degrades irregularly, which can occasionally produce palpable nodules. PDLLA is amorphous with uniform microsphere size, leading to more predictable degradation. Some Juvelook formulations also combine PDLLA with hyaluronic acid, providing immediate hydration alongside gradual collagen stimulation. They share the same general mechanism but differ in material science and clinical behavior."
  - q: "How long do biostimulator results last?"
    a: "Duration varies by product. Sculptra results typically last 18–24 months or longer. Juvelook results last 12–18 months depending on formulation. Radiesse lasts 12–18 months. Ellanse offers the longest duration, with formulations ranging from 1 to 4 years. However, individual metabolism, treatment area, and injection technique all affect longevity. Most biostimulators require 2–3 initial sessions spaced 4–6 weeks apart to build adequate collagen."
  - q: "What is a hybrid biostimulator protocol?"
    a: "A hybrid protocol combines an energy device — such as a fractional laser, radiofrequency, or microneedling device — with a biostimulator injection, either in the same session or sequenced days apart. The energy device creates controlled micro-injury that activates wound healing pathways. The biostimulator provides the scaffold or stimulus that amplifies collagen production during that healing window. Korean dermatologists have refined these combination approaches, and early evidence suggests synergistic improvement in skin quality."
  - q: "Who should not get biostimulator injections?"
    a: "Patients with active autoimmune conditions, particularly those affecting connective tissue, should avoid biostimulators because the foreign body reaction that drives collagen production may behave unpredictably. Patients with a history of hypertrophic scarring or keloid formation need careful evaluation. Patients who expect immediate visible results — biostimulators take weeks to months — may be better served by HA fillers. And patients who prioritize reversibility should know that biostimulators cannot be dissolved enzymatically."
---
...
## The Reframe: From Filling Volume to Rebuilding Tissue
...
## Five Products, One Mechanism, Different Materials
...
**Manufacturer:** Galderma (originally Sanofi/Dermik)
**Active material:** PLLA microparticles suspended in carboxymethylcellulose and mannitol
**Mechanism:** Semi-crystalline PLLA particles degrade over 12–18 months through hydrolysis. During degradation, the surrounding tissue responds with fibroblast activation and collagen deposition.
**Clinical profile:** Requires reconstitution 24–72 hours before injection. Typically 2–3 sessions spaced 4–6 weeks apart. Results emerge gradually over 2–6 months. Duration: 18–24 months or longer.
**Considerations:** The semi-crystalline structure of PLLA means degradation is somewhat uneven — some particles break down faster than others. This can occasionally produce subcutaneous nodules, particularly if reconstitution is inadequate, dilution is insufficient, or post-injection massage is not performed properly. Proper technique significantly reduces this risk.
...
### Juvelook — PDLLA (Poly-D,L-Lactic Acid)

**Manufacturer:** Humedix (Korea)
**Active material:** PDLLA microspheres, available as PDLLA alone or as PDLLA combined with non-cross-linked HA
**Mechanism:** Amorphous PDLLA degrades through hydrolysis more uniformly than semi-crystalline PLLA because it lacks the crystalline domains that resist degradation. The uniform microsphere size (typically 4–12 micrometers) provides predictable surface area for controlled foreign body reaction.
...
**Manufacturer:** REGEN Biotech (Korea)
**Active material:** PDLLA microspheres with 98.7% purity, porous microsphere architecture
**Mechanism:** Same core PDLLA mechanism as Juvelook but with a distinctive porous microsphere surface that increases surface area for cellular infiltration.
**Clinical profile:** The porous structure allows fibroblasts to penetrate the microsphere rather than only encapsulating it from outside. This may accelerate and intensify collagen deposition. Duration: 18–36 months reported in some studies.
**Considerations:** AestheFill's porous architecture is a genuine differentiator within the PDLLA category. Longer reconstitution time is recommended to hydrate the porous surfaces fully.
...
**Active material:** CaHA microspheres suspended in a carboxymethylcellulose gel carrier
**Mechanism:** Dual-phase: the gel carrier provides immediate volume, while CaHA microspheres stimulate collagen over 3–6 months as they are gradually resorbed.
**Clinical profile:** Immediate volumizing effect plus delayed collagen stimulation. Can be diluted (hyperdilute Radiesse) for skin quality improvement over large surface areas. Duration: 12–18 months.
**Considerations:** CaHA is radiopaque on imaging, which is a consideration for patients who may undergo facial CT or MRI. Cannot be dissolved with hyaluronidase. Higher viscosity than PLLA/PDLLA products.

---

### Ellanse — PCL (Polycaprolactone)

**Manufacturer:** Sinclair Pharma (AQTIS Medical)
**Active material:** PCL microspheres in a carboxymethylcellulose gel carrier
**Mechanism:** Dual-phase like Radiesse — immediate volume from gel carrier, delayed collagen stimulation from PCL degradation.
**Clinical profile:** Available in multiple formulations designated by duration: Ellanse-S (1 year), Ellanse-M (2 years), Ellanse-L (3 years), Ellanse-E (4 years). The PCL microsphere size and total volume determine longevity.
**Considerations:** The longest-lasting biostimulator available. This is an advantage for patients who want durability but a significant commitment given irreversibility. Not FDA-approved in the US as of 2026, but widely used in Europe and Asia.

---

## Why Hybrid Protocols Work
...
## Patient Selection: Who Benefits, Who Should Wait
...
**Related reading:** [Dermal Filler Brands: A Physician's Guide](/en/blog/filler-brands-products-guide) — how HA fillers and collagen stimulators compare by physical properties. [Thread Lifting: PDO vs. PCL vs. PLLA](/en/blog/thread-lifting-pdo-pcl-plla-guide) — another collagen-stimulating approach using absorbable sutures. [Why Korea for Medical Care](/en/blog/why-korea-for-medical-care) — why Seoul leads in aesthetic medicine.
