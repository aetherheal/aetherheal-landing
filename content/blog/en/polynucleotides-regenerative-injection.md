...
tags: ["polynucleotides", "pdrn", "regenerative-medicine", "skin-rejuvenation", "aesthetic-medicine", "korea"]
coverImage: "/assets/blog/polynucleotides-regenerative-injection-cover.webp"
published: true
takeaways:
  - "Polynucleotides (PN) are DNA-derived fragments that promote tissue repair through A2A receptor activation, fibroblast stimulation, and anti-inflammatory pathways — they are biologically active, not inert volumizers."
  - "PN, PDRN, and exosomes are distinct categories with different molecular weights, mechanisms, and evidence levels — grouping them together under 'regenerative' branding obscures real differences that matter clinically."
  - "Korea is a global hub for PN/PDRN treatment development and clinical practice, with products like Rejuran, Nucleofill, and Plinest in routine use across dermatology and aesthetic clinics."
  - "Clinical evidence from RCTs supports PN/PDRN efficacy for wound healing, skin hydration, and texture improvement, but many marketing claims — particularly around deep wrinkle reversal and structural rejuvenation — exceed what controlled studies have demonstrated."
  - "Standardization remains a major limitation: PN products vary in molecular weight, source material, purification, and concentration, making cross-product comparisons unreliable and protocol standardization difficult."
faq:
  - q: "What are polynucleotides and how do they differ from fillers?"
    a: "Polynucleotides are fragments of DNA, typically derived from salmon or trout sperm cells, with molecular weights usually between 50 and 1,500 kDa. Unlike hyaluronic acid fillers, which add volume mechanically, polynucleotides work biologically — they activate adenosine A2A receptors on cell surfaces, stimulate fibroblast activity, promote angiogenesis, and reduce local inflammation. The goal is tissue repair and skin quality improvement rather than volumization. They do not fill or lift; they aim to improve the biological environment of the skin."
  - q: "What is the difference between PN, PDRN, and exosomes?"
    a: "PDRN (polydeoxyribonucleotide) has a molecular weight of 50–1,500 kDa and primarily works through A2A adenosine receptor activation. PN (polynucleotide) is a broader category that includes longer-chain DNA fragments, often above 1,000 kDa, with additional mechanisms including direct scaffolding effects and ECM modulation. Exosomes are lipid-membrane vesicles secreted by cells, carrying proteins, RNA, and signaling molecules — an entirely different biological entity. All three are marketed under regenerative medicine, but their mechanisms, evidence bases, and regulatory classifications differ substantially."
  - q: "Is Rejuran the same as other polynucleotide products?"
    a: "No. Rejuran (made by Pharma Research, Korea) is a PDRN-based product derived from salmon DNA. Other products like Nucleofill (Italy) and Plinest (Italy) use polynucleotides with different molecular weight ranges, purification processes, and concentrations. Even within PDRN products, the source material, fragment size distribution, and formulation vary. Treating all PN/PDRN products as interchangeable ignores manufacturing differences that may affect clinical performance. The evidence supporting one product does not automatically transfer to another."
  - q: "What does the clinical evidence actually support for PN/PDRN?"
    a: "Randomized controlled trials support PDRN efficacy in wound healing (particularly diabetic ulcers), skin hydration improvement, and modest texture enhancement. Some controlled studies show improvement in fine lines and skin elasticity measurements. However, most aesthetic claims — dramatic wrinkle reversal, pore reduction, deep structural rejuvenation — come from uncontrolled case series, manufacturer-sponsored studies, or clinical observation rather than rigorous RCTs. The evidence is real but narrower than the marketing suggests."
  - q: "How do Korean dermatologists typically use PN/PDRN treatments?"
    a: "Korean protocols commonly involve serial intradermal injections at the papillary or upper dermal level, spaced two to four weeks apart for an initial series of three to five sessions, followed by maintenance every one to three months. Many clinics combine PN/PDRN with microneedling, laser toning, or energy-based devices in the same session or alternating sessions. The injection technique — multiple micro-deposits across the treatment area rather than bolus injection — is considered important for even distribution. Combination approaches are the norm, not the exception."
---
...
## Regenerative Is a Category, Not a Guarantee
...
## What the Science Shows — and Where It Stops
...
For international patients exploring these treatments, Korea offers both the deepest clinical experience and the widest product availability. Understanding the [physician consultation process](/en/how-it-works) helps contextualize how these protocols are developed on an individual basis.

---

## Where the Evidence Ends and the Uncertainty Begins
...
## Thinking Clearly About a Promising but Incomplete Story
...
**Related reading:** [Dermal Filler Brands: A Physician's Guide](/en/blog/filler-brands-products-guide) — understanding HA fillers and biostimulators alongside PN/PDRN. [MCT: Skin Rejuvenation Without Heat](/en/blog/mct-microcoring-skin-rejuvenation) — a mechanical approach to skin quality. [Why Korea for Medical Care](/en/blog/why-korea-for-medical-care) — context on Korea's leadership in aesthetic innovation.
