  ...
  return (
    <div className="min-h-full">
      ...
      <section className="w-full py-20 sm:py-28 px-4 sm:px-6 bg-white">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="font-serif text-3xl sm:text-4xl text-brand-navy mb-4">어떤 분이신가요?</h2>
            <p className="text-text-muted text-lg">해당하는 항목을 선택해 주십시오.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
            <Link href={`${prefix}/for-partners`} className="group">
              <div className="h-full rounded-3xl border border-slate-200 bg-white p-8 sm:p-10 shadow-[0_20px_50px_-12px_rgba(15,23,42,0.06)] hover:shadow-[0_25px_60px_-12px_rgba(15,23,42,0.12)] hover:border-brand-gold/30 transition-all duration-300">
                ...
                <h3 className="font-serif text-2xl text-brand-navy font-semibold mb-3">파트너 병원이신가요?</h3>
                <p className="text-text-body leading-relaxed mb-6">
                  AetherHeal이 파트너 병원에 제공하는 가치, Trust Protocol 심사 과정, 그리고 참여 조건을 확인하세요.
                </p>
                <span className="inline-flex items-center gap-2 text-sm font-semibold text-brand-navy group-hover:text-brand-gold transition-colors">
                  파트너 안내 보기
            ...
            <Link href={`${prefix}/for-investors`} className="group">
              <div className="h-full rounded-3xl border border-slate-200 bg-white p-8 sm:p-10 shadow-[0_20px_50px_-12px_rgba(15,23,42,0.06)] hover:shadow-[0_25px_60px_-12px_rgba(15,23,42,0.12)] hover:border-brand-navy/30 transition-all duration-300">
                ...
                <h3 className="font-serif text-2xl text-brand-navy font-semibold mb-3">투자자이신가요?</h3>
                <p className="text-text-body leading-relaxed mb-6">
      ...
      <section className="w-full py-20 sm:py-28 px-4 sm:px-6 bg-bg-light border-t border-slate-100">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="font-serif text-3xl sm:text-4xl text-brand-navy mb-4">AetherHeal의 핵심 구조</h2>
            <p className="text-text-muted text-lg max-w-2xl mx-auto">기존 에이전시와 근본적으로 다른 세 가지 아키텍처적 특징.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="rounded-2xl border border-slate-200 bg-white p-7">
              ...
              <h3 className="font-serif text-lg text-brand-navy font-semibold mb-3">구조적 인센티브 분리</h3>
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-7">
              ...
              <h3 className="font-serif text-lg text-brand-navy font-semibold mb-3">의사 주도 검증</h3>
              <p className="text-sm text-text-body leading-relaxed">
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-7">
              ...
              <h3 className="font-serif text-lg text-brand-navy font-semibold mb-3">AI + 인간 거버넌스</h3>
              <p className="text-sm text-text-body leading-relaxed">
      ...
      <section className="w-full py-20 sm:py-28 px-4 sm:px-6 bg-white border-t border-slate-100">
        <div className="max-w-3xl mx-auto text-center space-y-8">
          ...
          <h2 className="font-serif text-3xl sm:text-4xl text-brand-navy">우리의 철학을 읽어보세요</h2>
          <p className="text-text-body text-lg leading-relaxed">
            AetherHeal이 존재하는 이유, 아커로프 시장 문제, SWIFT 구조의 유비, 그리고 창업자의 의무에 대해 설명합니다.
          </p>
          <Link
            href={`${prefix}/our-philosophy`}
            className="inline-flex items-center gap-2 px-6 py-3 text-sm font-semibold text-white bg-brand-navy rounded-full hover:bg-brand-navy/90 transition-all hover:shadow-md"
          >
            우리의 철학 전문 읽기
      ...
      <section className="w-full py-16 sm:py-20 px-4 sm:px-6 bg-brand-navy">
        <div className="max-w-3xl mx-auto text-center space-y-4">
          <p className="text-slate-400 text-sm">영문 환자용 사이트를 방문하시려면</p>
          <Link
            href="/en"
