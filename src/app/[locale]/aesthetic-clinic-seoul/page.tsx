...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: { title: t.title, description: t.description, url: `https://aetherheal.com/${locale}/aesthetic-clinic-seoul`, images: [{ url: "/og-image.jpg", width: 1200, height: 630 }] },
